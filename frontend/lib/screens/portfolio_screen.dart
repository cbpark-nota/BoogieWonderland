...
class PortfolioScreen extends ConsumerWidget {
      ...
      body: RefreshIndicator(
        ...
        child: portfolioAsync.when(
          data: (portfolio) => portfolio.isEmpty
              ...
              : _buildPortfolio(context, ref, portfolio, isUploaded, signalAsync.asData?.value),
  ...
  Widget _buildPortfolio(
      BuildContext context, WidgetRef ref, PortfolioData portfolio, bool isUploaded, RebalanceSignal? signal) {
    return ListView(
